...
const AccordionItem: Component<AccordionPrimitive.AccordionItemProps> = (
  ...
  return (
    <AccordionPrimitive.Item
      class={cn(
        'text-[#6f6e84] border-b-[1px]  border-b-[#2b2b3b]',
        props.class
      )}
      {...rest}
    />
  ...
  return (
    <AccordionPrimitive.Header class="flex">
      <AccordionPrimitive.Trigger
        class={cn(
          'flex flex-1 items-center focus:outline-none justify-between py-4 font-medium transition-all hover:underline [&[data-expanded]>svg]:rotate-180',
          props.class
        )}
        {...rest}
      >
