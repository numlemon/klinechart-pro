...
const RadioGroupItem: Component<RadioGroupPrimitive.RadioGroupItemProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <RadioGroupPrimitive.ItemControl class="aspect-square h-4 w-4 rounded-full border border-white text-white ring-offset-whit focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
